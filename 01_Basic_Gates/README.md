...
### 01. AND GATE
**Description:** Output is HIGH (1) only if all inputs are HIGH.
...
### 03. NOT GATE
**Description:** A single-input inverter that reverses the logic state.
...
### 04. NAND GATE
**Description:** Universal gate; outputs LOW (0) only when all inputs are HIGH.
**Boolean Expression:** Y = (A · B)'
...
### 05. NOR GATE
**Description:** Universal gate; outputs HIGH (1) only when all inputs are LOW.
**Boolean Expression:** Y = (A + B)'
...
### 06. XOR GATE(Exclusive OR)
**Description:** Outputs HIGH (1) when the inputs are different. Crucial for arithmetic adders.
**Boolean Expression:** Y = A ⊕ B
...
### 07. XNOR GATE(Exclusive NOR)
**Description:** Outputs HIGH (1) when the inputs are identical. Used as a digital comparator.
**Boolean Expression:** Y = (A ⊕ B)'
